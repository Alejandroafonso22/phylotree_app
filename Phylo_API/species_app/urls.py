...
occurrences_post_add, occurrences_getdetails, login_token, species_by_default, user_api_register, get_markers_with_names
)
urlpatterns=[
    ...
    path('api/bridge/<int:download_id>', bridge)
]